...
define(['dojo/_base/declare',
  ...
  function(declare, lang, html, array, baseFx, on, aspect, domClass, BaseWidgetPanel, BaseWidgetFrame, utils, FoldableDijit, FoldableWidgetFrame) {
    var criticality = 360;
    ...
    return declare([BaseWidgetPanel, FoldableDijit], {
      ...
      createCloseBtn: function() {
        if (this.isFull) {
          ...
          this.minimizeNode = html.create('div', {
            'class': 'minimize-btn jimu-vcenter'
          }, this.titleNode);
          
			this.minimizeBtnHandle = on(this.minimizeNode, 'click', lang.hitch(this, function(evt) {
            evt.stopPropagation();
            this.onTitleClick();
          }));
      ...
      onTitleClick: function() {
        ...
        if (this.folded) {
		  ...
		  domClass.replace(this.minimizeNode,'minimize-btn jimu-vcenter','maximize-btn jimu-vcenter');
          if (this.iframePane) {
          ...
          this.folded = true;
          domClass.replace(this.minimizeNode,'maximize-btn jimu-vcenter','minimize-btn jimu-vcenter');
          ch = 0;
          html.setStyle(this.domNode, {
            height: this.titleHeight + 'px'
          });
