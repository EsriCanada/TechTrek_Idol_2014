		...
		return declare([], {
			...
			findChargingStationNearestTo:function(point, rangeRemaining, distortionFactor) {
				...
				return {
					...
					stop:{extent:closestStation._extent,name:closestStation.attributes["AddressLine1"]+", "+closestStation.attributes["AddressTown"],feature:{geometry:closestStation.geometry,attributes:closestStation.attributes}},
