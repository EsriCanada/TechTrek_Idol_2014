            ...
            toolbar.startup().then(lang.hitch(this, function () {
                ...
                for (var i = 0; i < this.config.tools.length; i++) {
                    ...
                    case "share":
                        ...
                        break;
                    default:
                        this.emit('found-custom-tool',{toolConfig:this.config.tools[i],toolList:toolList,toolbar:toolbar});
                        break;
                    }
                }
